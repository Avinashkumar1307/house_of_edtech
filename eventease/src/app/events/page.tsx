...
import { Plus, Calendar, MapPin, Users, Eye, MoreVertical, Edit, Trash2, Download, Search, Filter, Grid, List } from 'lucide-react'
          ...
          <div className="glass-effect rounded-xl p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {events.reduce((sum, event) => sum + (event._count?.rsvps || 0), 0)}
                </p>
              </div>
                ...
                >
                  <div className={viewMode === 'list' ? 'flex-1' : ''}>
                    ...
                    <div className="flex items-center justify-between mb-3">
                      <span className={`px-2 py-1 text-xs font-medium rounded-full ${getStatusColor(getEventStatus(event))}`}>
